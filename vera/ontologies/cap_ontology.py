...
async def co_export_to_ontologies(
    ...
    try:
        from Vera.vera.skills.skills import ONTOLOGIES, ontologies_create, ontologies_update
...
import Vera.vera.capability_orchestration as _orch
from Vera.vera.capability_orchestration import capability, CAPABILITY_REGISTRY
