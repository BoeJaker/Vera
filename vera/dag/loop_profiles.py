...
LOOP_PROFILES: List[Dict[str, Any]] = [
    {
        ...
        "caps": ["fabric.query", "fabric.datasets", "fabric.stats",
                 ...
                 "memory.seek", "memory.map", "caps.search", "web.search"],
    ...
    },
    {
        ...
        "caps": ["exec.python.run", "exec.bash.run",
                 "ide.fs.read", "ide.fs.write", "ide.code.grep",
                 "ide.code.outline", "ide.code.tool_manifest",
                 "code.save", "code.read", "code.versions"],
    ...
    },
    {
        ...
        "caps": ["ide.fs.read", "ide.fs.write", "ide.fs.list", "ide.fs.browse",
    ...
    },
    {
        ...
        "caps": ["ide.fs.read", "ide.fs.write", "ide.fs.list", "ide.code.grep",
    ...
    },
    {
        ...
        "caps": ["caps.search", "fabric.query", "web.search"],
        "skills": "",
        "panels": True,
