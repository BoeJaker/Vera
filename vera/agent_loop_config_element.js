...
(function () {
  ...
  const FIELDS = [
    ...
    { k: 'enable_chaining', g: 'adaptive', t: 'bool', def: true, vers: ['v6'], label: 'Stage-agent cap chaining', hint: 'Let a step\'s specialist chain several caps in ONE turn, piping each output into the next (e.g. llm.generate → ide.fs.write) with NO inference between hops — cheaper and more reliable than doing it call-by-call.' },
