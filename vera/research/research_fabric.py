...
def _registry():
    ...
    co = (sys.modules.get("Vera.vera.capability_orchestration") or
          sys.modules.get("capability_orchestration"))
    return getattr(co, "CAPABILITY_REGISTRY", {}) if co else {}

def _orch():
    """Resolve orchestrator module."""
    return (sys.modules.get("Vera.vera.capability_orchestration") or
            sys.modules.get("capability_orchestration"))
...
def _memory_hooks():
    ...
    return (sys.modules.get("Vera.vera.memory_hooks") or
